...
export function unfollow(
  ...
  return client.del<FollowResultEnvelope>(`/users/${encodeURIComponent(sub)}/follow`, { signal });
}
...
export function listFollowers(
  ...
  return client.get<FollowListResponse>(`/users/${encodeURIComponent(sub)}/followers`, {
    signal,
...
export function listFollowing(
  ...
  return client.get<FollowListResponse>(`/users/${encodeURIComponent(sub)}/following`, {
    signal,
    query: { cursor: q.cursor, limit: q.limit },
  });
}
