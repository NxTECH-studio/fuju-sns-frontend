...
describe('CreatePostForm', () => {
  it('should render form inputs', () => {
    ...
    render(<CreatePostForm onSubmit={mockOnSubmit} />);

    const textarea =
      screen.getByPlaceholderText(/何が起きている/i) ||
  ...
  it('should render submit button', () => {
    ...
    const submitButton =
      screen.getByRole('button', { name: /投稿|post|送信/i }) ||
  ...
  it('should call onSubmit with content when form is submitted', async () => {
    ...
    const submitButton =
      screen
        .getAllByRole('button')
        .find((btn) => btn.textContent?.includes('投稿') || btn.textContent?.includes('submit')) ||
  ...
  it('should show loading state', () => {
    ...
    const { rerender } = render(<CreatePostForm onSubmit={mockOnSubmit} isLoading={false} />);

    rerender(<CreatePostForm onSubmit={mockOnSubmit} isLoading={true} />);
