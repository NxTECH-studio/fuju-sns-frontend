...
export function PostDetailRoute() {
  ...
  if (detail.error) return <p style={{ color: '#d33' }}>エラー: {detail.error}</p>;
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <PostRow
        ...
        meSub={meSub}
        onOpenAuthor={
          detail.post.author ? () => navigate(`/users/${detail.post!.author!.sub}`) : undefined
        }
      ...
      {detail.replies.length === 0 ? (
        ...
        detail.replies.map((r) => (
          <PostRow
            ...
            onOpenAuthor={r.author ? () => navigate(`/users/${r.author!.sub}`) : undefined}
